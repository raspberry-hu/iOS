...
public enum Strings {
  ...
  public enum Localizable {
    ...
    public static let enableLocationServicesForBackgroundUpload = Strings.tr("Localizable", "Enable location services for background upload")
    ...
    /// MEGA can periodically start camera uploads in the background when your location changes.
    public static let megaCanPeriodicallyStartCameraUploadsInBackgroundWhenYourLocationChanges = Strings.tr("Localizable", "MEGA can periodically start camera uploads in background when your location changes.")
    ...
    /// Please select “Always” at your Location page in Settings, so that MEGA can periodically start camera uploads in background when your location changes.
    public static let pleaseSelectAlwaysAtYourLocationPageInSettingsThenMEGACanPeriodicallyStartCameraUploadsInBackgroundWhenYourLocationChanges = Strings.tr("Localizable", "Please select “Always” at your Location page in Settings, then MEGA can periodically start camera uploads in background when your location changes.")
    ...
    /// Turn On
    public static let turnOn = Strings.tr("Localizable", "Turn On")
    /// Turn On in Settings
    public static let turnOnInSettings = Strings.tr("Localizable", "Turn On in Settings")
    ...
    public static let uploadInBackground = Strings.tr("Localizable", "Upload in Background")
